...
export function routingFunc(args) {
   ...
   *    }
   * @apiParam {String} provider 필수 유저의 인증 타입 (kakao/email)
   ...
   * @apiSuccess {String} access_token FB 액세스 토큰
  ...
  /**
   * @api {patch} /api/v1/user/initial/:uid Update Initial User Information
