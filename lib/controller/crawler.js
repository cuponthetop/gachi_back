...
var number_crawler = new Crawler({
    ...
    callback : function (error, res, done) {
        if(error){
            ...
            number = number.replace(/total/gi, "");
            ...
            total_info.page_numbers = page_numbers;
            ...
            if(error){
                ...
                var $ = cheerio.load(res.body);
                  ...
                  for(var i=0; i<15; i++){
                      ...
                      {name, image, genre, start_date, end_date, location};
                      console.log(name);
                      console.log(image);
                      console.log(genre);
