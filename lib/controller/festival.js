...
export class FestivalController {
  ...
  async getFestival(req, res) {
    ...
    try {
      ...
      let leadroom = await festival.getLeadrooms();
      let result = null;

      result = await addGenre(festival);
      _.set(result, 'leadrooms', leadroom);
