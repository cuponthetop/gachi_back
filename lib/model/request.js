...
import { ENUM, UUID, UUIDV4, STRING } from 'sequelize';
...
export class RequestManager {
  constructor(dataService) {
    ...
    this.request.belongsTo(leadroom, { as: 'leadroom', foreignKey: 'leadroom_id' });
    this.request.belongsTo(user, { as: 'requester', foreignKey: 'requester_id' });
  }
