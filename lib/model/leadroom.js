...
export class LeadroomManager {
  constructor(dataService) {
    ...
    // festival.hasMany(this.leadroom, { foreignKey: 'fid' });
    this.leadroom.belongsTo(festival, { foreignKey: 'fid', targetKey: 'fid' });
    // user has many leadrooms
    // user.hasMany(this.leadroom, { as: 'leader', foreignKey: 'leader_id' });
