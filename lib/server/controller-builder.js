...
export async function handlerServiceBuilder(args) {
  ...
  _.assign(ret, { requestCtrl: new RequestController(userManager, festivalManager, leadroomManager, requestManager) });
  _.assign(ret, { leadroomCtrl: new LeadroomController(userManager, festivalManager, leadroomManager, leadroomMemberManager) });
